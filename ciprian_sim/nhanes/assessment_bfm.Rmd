...
```{r}
# ---- Histograms of Correlations: Before and After K=1 Removal (All Methods) ----

# Utility: extract off-diagonal (upper triangle) correlations
...
# Plot histograms, before and after, for each method (blue=before, red=after)
par(mfrow = c(2, 2), mar = c(4,4,3,1))
hist(offdiag_before_trio, breaks = 30, col = rgb(0.2,0.2,0.7,0.4),
     main = "MoM-Trio: Before", xlab = "Correlation", xlim = c(-1,1))
hist(offdiag_after_trio, breaks = 30, col = rgb(0.9,0.1,0.1,0.4),
     main = "MoM-Trio: After", xlab = "Correlation", xlim = c(-1,1))

hist(offdiag_before_mgsp, breaks = 30, col = rgb(0.2,0.2,0.7,0.4),
     main = "MGSP: Before", xlab = "Correlation", xlim = c(-1,1))
hist(offdiag_after_mgsp, breaks = 30, col = rgb(0.9,0.1,0.1,0.4),
     main = "MGSP: After", xlab = "Correlation", xlim = c(-1,1))

par(mfrow = c(2, 2), mar = c(4,4,3,1))
hist(offdiag_before_hs, breaks = 30, col = rgb(0.2,0.2,0.7,0.4),
     main = "Horseshoe: Before", xlab = "Correlation", xlim = c(-1,1))
hist(offdiag_after_hs, breaks = 30, col = rgb(0.9,0.1,0.1,0.4),
     main = "Horseshoe: After", xlab = "Correlation", xlim = c(-1,1))

hist(offdiag_before_ssl, breaks = 30, col = rgb(0.2,0.2,0.7,0.4),
     main = "Spike-and-Slab: Before", xlab = "Correlation", xlim = c(-1,1))
hist(offdiag_after_ssl, breaks = 30, col = rgb(0.9,0.1,0.1,0.4),
     main = "Spike-and-Slab: After", xlab = "Correlation", xlim = c(-1,1))
