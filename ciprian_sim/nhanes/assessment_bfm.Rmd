...
# Pairwise scatterplots for all methods
...
# Example: MoM-Trio vs Spike-and-Slab
...
# Optionally, check differences as histograms
hist(compare_lambda1_bi$MoM_Trio - compare_lambda1_bi$MGSP,
     main="MoM-Trio minus MGSP (lambda1_bi)",
     xlab="Difference", col="skyblue")
