...
#Sigma2 = 0.6, 10 moderate, 10 null, normalized
...
sim <- readRDS("sim_fixed_lambda_k1_5.rds")
X   <- sim$X            # n × P
P   <- ncol(X)
...
#below is identifiable UP TO SIGN...

```{r}

b_true   <- sim$b          # true bᵢ
#lambda2  <- <your MoM‐Trio λₚ² estimates>
sigma2   <- 0.6            # known noise variance
